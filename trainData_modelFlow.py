...
from datasetGenerator_modelFlow import *
...
plot_model(model_cnn, to_file='figs/modelFlow_plot.png', show_shapes=True, show_layer_names=True)
...
print("Training model with {} files and validating with {} files".format(len(train_files), len(test_files)));
